...
<div class="row">
    ...
    <div class="row">
     ...
     <div class="col-md-4" align="right"><img alt="Sign-In" src="img/admin.jpg" width="200px" height="200px"></div>
     
        <div class="well col-md-5 login-box">
            <div class="alert alert-info">
                Please login with your Email-ID and Password.
            </div>
            <form class="form-horizontal" action="AdminLoginController" method="post">
                <fieldset>
