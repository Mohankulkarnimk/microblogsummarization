...
<div class="ch-container">
    ...
    <div class="row">
        ...
        <%
        	ArrayList<RealTweetStream> realTweetList= (ArrayList<RealTweetStream>) session.getAttribute("RealTweetStream");
        	for(int i=0;i<realTweetList.size();i++){
        %>
        
            <div class="">            
              	
               	<div class="col-md-6"><h5><%=realTweetList.get(i).getUserName() %></h5></div>
           </div>
           <br><br>
            <div>
            	<div>  <%if(realTweetList.get(i).getVideourl()!=null && !realTweetList.get(i).getVideourl().equals("")){%> 
            	<br><div><video width="400" height="240" controls>  
  					<source src="<%=realTweetList.get(i).getVideourl() %>" type="video/mp4" class="img-square">  </video> </div>
  					<%}else if(realTweetList.get(i).getImgurl()!=null && !realTweetList.get(i).getImgurl().equals("")){ %>        
            	<br><div><img alt="Tweet Pic" class="img-square" src="<%=realTweetList.get(i).getImgurl() %>"  width="300px" height="150px"/></div>
            	<%} %>            
            	<div><h5 style="color:black"><%=realTweetList.get(i).getTweetContent() %></h5></div>
            	</div>
            </div>
            <hr>
        <%} %>
        		   <p class="left col-md-5">
                        <a href="AdminSimilarityController" class="btn btn-primary">Similarity Analysis</a>
                   </p>
        </div>
        <!--/span-->
