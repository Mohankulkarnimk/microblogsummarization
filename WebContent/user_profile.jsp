...
<div class="row">
    <div class="col-md-9 center"><div class="col-md-1"></div>
        <div class="well col-md-7 login-box">
			...
			%>
                         <br>
                <div class="col-md-4">
                <img alt="Profile Pic" src="profilepic.jsp?id=<%=userId %>" class="hidden-xs" height="150" width="150"/>
                </div>
                <div class="col-md-5">                
                    <table>
                    <tr>
        ...
        <!--/span-->
        <div class="col-md-3" align="right"><img alt="Sign-In" src="img/user_reg2.jpg" width="200px" height="200px"></div>
    </div>
    </div><!--/row-->
