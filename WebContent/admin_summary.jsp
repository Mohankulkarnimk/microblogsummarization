...
<div class="row">        
        ...
        <div class="col-md-8 center login-header">
            <h2 align="center">Final Summary</h2>
        </div>
        <!--/span-->
    ...
    <div class="row">
        <div class="well col-md-4 center login-box">
            ...
            <form action="admin_home.jsp" method="post">
                <fieldset>
                <% String summary = (String)session.getAttribute("FinalSummary"); %> 
                    <div class="form-group">
                        <label>Summary Result:</label>
						<textarea class="form-control" rows="10" cols="100" name="msg"><%=summary %></textarea>			 
                    </div>
