...
<div class="ch-container">
	...
	<div class="row">        
		...
		%>
            ...
            <h2 align="center">Followings : <%=request.getAttribute("Count") %></h2>
        </div>
        <!--/span-->
   ...
   <div class="row">
        <div class="well col-md-9  login-box">
    		...
    		<tbody>
    		<%
    			ArrayList<Follower> followingList = (ArrayList<Follower>)request.getAttribute("followingList");
    			if(followingList!=null && followingList.size()>0){
    				for(int i=0;i<followingList.size();i++){
    		%>
    		<tr>
    			<td><img alt="Profile Pic" class="img-square" src="profilepic.jsp?id=<%=followingList.get(i).getReceiver().getUserId() %>"  width="80px" height="50px"/></td>
    			<td><%=followingList.get(i).getReceiver().getFname()+" "+followingList.get(i).getReceiver().getLname() %></td>
        		<td><%=followingList.get(i).getReceiver().getEmail() %></td>
        		<td><%=followingList.get(i).getReceiver().getAddress() %></td>
    		</tr>
    		<%		}
    			}
    		%>
