        ...
        <%} %>
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="user_search.jsp"><i
                         ...
                         <li><a class="ajax-link" href="user_real.jsp"><i
                                    class="glyphicon glyphicon-eye-open"></i><span> real time tweet </span></a></li>
...
<div class="row">        
		...
		%>
            ...
            <h2 align="center">Send Tweets</h2>
        </div>
        <!--/span-->
